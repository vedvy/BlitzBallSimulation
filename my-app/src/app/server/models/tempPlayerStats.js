...
const tempPlayerStatsSchema = new Schema({
    ...
    HitterStats: {
        ...
        Average: {type: mongoose.Types.Decimal128, default: 1},
        SLGPercent: {type: mongoose.Types.Decimal128, default: 1},
        OBPPercent: {type: mongoose.Types.Decimal128, default: 1},
        OnBasePlusSlugging: {type: mongoose.Types.Decimal128, default: 1},
        ...
        BatAvgBallsInPlay: {type: mongoose.Types.Decimal128, default: 1},
        IsolatedPower: {type: mongoose.Types.Decimal128, default: 1},
